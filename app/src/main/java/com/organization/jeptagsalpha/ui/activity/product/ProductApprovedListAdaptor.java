...
public class ProductApprovedListAdaptor extends BaseAdapter {
  ...
  //  ArrayList<User> Contact=new ArrayList<>();
    ...
    LayoutInflater mInflater;
    private Activity context;//
    public ProductApprovedListAdaptor(FragmentActivity activity, ArrayList<ProductDetails> storeContacts) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        view = mInflater.inflate(R.layout.approved_adapter_layout, null);
        ...
        add=(AppCompatTextView)view.findViewById(R.id.addJepTagBtn);
        ...
        if(productDetailsArrayList.get(i).getImage()!=null){
            Picasso.with(ApprovedProductList.context).load(productDetailsArrayList.get(i).getImage()).into(mImageView);
        }
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adJepTagIntent.putExtra("pr_id", productDetailsArrayList.get(i).getProduct_id());
                adJepTagIntent.putExtra("pr_name", productDetailsArrayList.get(i).getName());
                adJepTagIntent.putExtra("pr_url", productDetailsArrayList.get(i).getProduct_url());
                adJepTagIntent.putExtra("pr_qty", productDetailsArrayList.get(i).getProduct_qty());
                adJepTagIntent.putExtra("longi", productDetailsArrayList.get(i).getProduct_longitude());
                adJepTagIntent.putExtra("lati", productDetailsArrayList.get(i).getProduct_latitude());
                adJepTagIntent.putExtra("image", productDetailsArrayList.get(i).getImage());
