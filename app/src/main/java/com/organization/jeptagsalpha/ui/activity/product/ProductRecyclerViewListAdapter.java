...
import com.organization.jeptagsalpha.ui.activity.product.ProductListFragment.OnListFragmentInteractionListener;
...
public class ProductRecyclerViewListAdapter extends RecyclerView.Adapter<ProductRecyclerViewListAdapter.ViewHolder> {

    private final List<ProductDetails> mValues;
    private final OnListFragmentInteractionListener mListener;
    ProgressDialog pDialog;

    public ProductRecyclerViewListAdapter(List<ProductDetails> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.listviewdatalayout, parent, false);
    ...
    //    holder.mCategory.setText(mValues.get(position).getCategory());
      ...
      //  getImage(mValues.get(position).getImage(),holder.pd_img);
        Picasso.with(ProductListActivity.context).load(mValues.get(position).getImage()).into(holder.pd_img);
        ...
        holder.addJepTagBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent adJepTagIntent=new Intent(ProductListActivity.context,AddJepTag.class);
                ...
                ProductListActivity.context.startActivity(adJepTagIntent);
            }
        });
        ...
        holder.infoJepTagBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iEdit = new Intent(ProductListActivity.context, EditProductDetails.class);
              ...
              //  iEdit.putExtra("listCount", listCount);
                ProductListActivity.context.startActivity(iEdit);
            }
        });
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(ProductListActivity.context);
                LayoutInflater layoutInflater = LayoutInflater.from(ProductListActivity.context);
                ...
                alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        if (checkBox.isChecked()) {
                            ...
                            alertDialog.setCancelable(false);
                            Toast.makeText(ProductListActivity.context, ProductListActivity.context.getString(R.string.toast_alert_delete_msg), Toast.LENGTH_LONG).show();
                        }
                    }
                });
