package com.organization.jeptagsalpha.wordpress.data;

import android.content.ContentValues;
import android.provider.BaseColumns;
import android.text.TextUtils;

import com.organization.jeptagsalpha.wordpress.model.MediaItem;
...
import com.organization.jeptagsalpha.wordpress.model.WPStatus;
import com.organization.jeptagsalpha.wordpress.util.DataConverters;
...
public class WordPressContract {
    ...
    interface PostColumns {
         ...
         * <P>Type : INTEGER (short)</P>
         *
         * @see webstersys.com.goshopping.wordpress.model.WPStatus
         */
