package com.organization.jeptagsalpha.wordpress;


import com.organization.jeptagsalpha.wordpress.model.Comment;
import com.organization.jeptagsalpha.wordpress.model.Media;
import com.organization.jeptagsalpha.wordpress.model.Meta;
import com.organization.jeptagsalpha.wordpress.model.Page;
...
public interface WordPressRestInterface {
    ...
    @POST("token")
    Call<Token> generateToken(@Body Map<String, Object> fieldMap);
    ...
    @GET("productsbyuser")
    Call<List<Product>> getProductListByUser(@QueryMap Map<String, String> params);
    ...
    @POST("products/batch")
    Call<BatchProduct> batchProductUpdate(@Body BatchProduct batchProduct);
}
